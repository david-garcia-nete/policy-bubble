 ...
 */
class Demographic extends \Application\Entity\Demographic implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'user', 'country', 'state', 'city', 'gender', 'birthYear'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Demographic $proxy) {
