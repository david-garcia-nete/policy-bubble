...
class AudioManager 
{
    ...
    public function __construct()
    {
        ...
        $this->s3bucket = $config->s3->s3audioBucket;
    }
     ...
     */
    public function getAudioPathByName($fileName, $id)
    {
     ...
     * @return string Path to image file.
     */
    public function getAddAudioPathByName($fileName, $id)
    {
        // Take some precautions to make file name secure
        $fileName = str_replace("/", "", $fileName);  // Remove slashes
        $fileName = str_replace("\\", "", $fileName); // Remove back-slashes
     ...
     * @return string|false
     */
    public function getAudioFileContent($filePath) 
    {
     ...
     */
    public  function resizeAudio($filePath, $desiredWidth = 240) 
    {
        // Get original image dimensions.
        list($originalWidth, $originalHeight) = getaudiosize($filePath);
