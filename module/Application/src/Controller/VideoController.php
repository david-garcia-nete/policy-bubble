...
class VideoController extends AbstractActionController 
{
     ...
     * Constructor.
     */
    public function __construct($videoManager)
    {
    ...
    public function fileAction() 
    {
        ...
        $fileName = $this->videoManager->getVideoPathByName($fileName, $postId, $loc);
                
        if($isThumbnail) {        
            // Resize the image
            $fileName = $this->videoManager->resizeVideo($fileName);
        }
                
        // Get image file info (size and MIME type).
        $fileInfo = $this->videoManager->getVideoFileInfo($fileName);        
        if ($fileInfo===false) {
        ...
        // Write file content        
        $fileContent = $this->videoManager->getVideoFileContent($fileName);
    ...
    public function removeTempAction() 
    {
        ...
        // Get path to image file
        $this->videoManager->removeTemp($fileName, $postId);
    ...
    public function removeAddTempAction() 
    {
        ...
        // Get path to image file
        $this->videoManager->removeAddTemp($fileName, $userId);
    ...
    public function addFileAction() 
    {
        ...
        // Get path to image file
        $fileName = $this->videoManager->getAddVideoPathByName($fileName, $userId);
